...
func TestAlgebraicExpressions(t *testing.T) {
	tests := []struct {
		...
		{EvalDivide, 2, DtypeInt, DtypeInt, DtypeFloat, "1,2", "2,8", "0.5,0.25", nil},
		...
		{EvalDivide, 3, DtypeInt, DtypeInt, DtypeFloat, "lit:34", "4,5,8", "8.5,6.8,4.25", nil},
		{EvalDivide, 3, DtypeInt, DtypeInt, DtypeFloat, "4,5,6", "lit:35", "0.11428571428571428,0.14285714285714285,0.17142857142857143", nil},
		{EvalDivide, 3, DtypeInt, DtypeInt, DtypeFloat, "lit:34", "lit:33", "lit:1.0303030303030303", nil},
